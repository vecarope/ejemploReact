import {exportExcelContactCompanies, exportExcelWorkProfile} from '../../../utils/exportExcel'
...
export const ExportCompanies = () => {
  return(
    ...
    onClick={exportExcelContactCompanies}
        className="inline-flex items-center btn bg-[#2563eb] border-white text-white py-3 m-4 font-light mx-1 btn-md"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          class="h-5 w-5 mr-2"
