  ...
  return (
    <div className="grid container h-40 mx-auto w-80 mr-5 md:w-screen md:h-50 md:mt-3 lg:my-10  lg:mx-20 lg:w-screen lg:h-80 lg:m-12">
      <div className="grid container my-10 mr-1 md:mx-5 lg:mx-5 ">
        <div class="grid grid-cols-8 sm:grid-cols-6 gap-4 ">
            ...
            <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
              <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                <tr>
                  ...
                  <th scope="col" className="px-6 py-3 ">Estatus Empleo</th>
                  <th scope="col" className="px-6 py-3 ">Stack</th>
                  <th scope="col" className="px-6 py-3 ">Nivel Educación</th>
                  <th scope="col" className="px-6 py-3 ">Último Estudio</th>
                  <th scope="col" className="px-6 py-3 ">Nivel Inglés</th>
                  <th scope="col" className="px-6 py-3 ">Conocimiento Adicional</th>
                  ...
                  <th scope="col" className="px-6 py-3 ">Portfalio</th>
                  <th scope="col" className="px-6 py-3 ">Experiencia Dev</th>
                  <th scope="col" className="mx-6 py-3 ">Trabajo Ideal</th>
                  <th scope="col" className="mx-6 py-3 ">Disponibilidad</th>
                </tr>
              </thead>
              <tbody>
                {applicant !== null ? (
