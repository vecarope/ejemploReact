          ...
          {DashboardData.map((item, index) => (
            <NavLink to={item.path}>
              {({ isActive }) =>
                <button
                  key={index}
                  className={`h-14 flex md:w-48 p-5 cursor-pointer focus:bg-light-purple hover:bg-light-purple hover:text-white focus:text-white rounded-md ${isActive ? 'bg-light-purple text-white' : ''
                    }`}>
